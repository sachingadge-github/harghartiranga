...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>हर घर तिरंगा - Home Repair Website Template</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <meta content="" name="keywords" />
    <meta content="" name="description" />

    <!-- Favicon -->
    <link href="https://technext.github.io/apex/img/favicon.ico" rel="icon" />
    ...
    <link href="https://technext.github.io/apex/lib/animate/animate.min.css" rel="stylesheet" />
    <link href="https://technext.github.io/apex/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet" />

    <!-- Customized Bootstrap Stylesheet -->
    <link href="https://technext.github.io/apex/css/bootstrap.min.css" rel="stylesheet" />
  ...
  <body>
      ...
      <div class="row gx-0 d-none d-lg-flex">
        <div class="col-lg-7 px-5 text-start">
          ...
          >
            ...
            <small>आजादी का अमृत महोत्सव</small>
          </div>
          ...
          <div class="h-100 d-inline-flex align-items-center border-end px-3">
            <small class="far fa-map-marker me-2"></small>
            <small>नांदेड वाघाळा शहर महानगरपालिका, नांदेड</small>
          </div>
        </div>
    ...
    >
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-3 py-lg-0">
          ...
          <a href="about.html" class="nav-item nav-link">नागरिक नोंदणी</a>
          <a href="service.html" class="nav-item nav-link">वितरक / उत्पादक नोंदणी</a>
          <a href="service.html" class="nav-item nav-link">डोनेट फ्लॅग</a>
          <a href="service.html" class="nav-item nav-link">मदत कक्ष</a>
          <a href="service.html" class="nav-item nav-link">लॉग इन</a>
      ...
      <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="w-100" src="bg1.jpg" alt="Image" />
          ...
          <div class="carousel-item">
            <img class="w-100" src="https://technext.github.io/apex/img/carousel-2.jpg" alt="Image" />
            <div class="carousel-caption">
              <div class="container">
                <div class="row justify-content-center">
                  <div class="col-12 col-lg-10">
      ...
      <div class="row g-0">
        <div class="col-xl-3 col-sm-6 wow fadeIn" data-wow-delay="0.1s">
          <div class="position-relative">
            <img class="img-fluid w-100" src="https://technext.github.io/apex/img/fact-1.jpg" alt="" />
        ...
        <div class="col-xl-3 col-sm-6 wow fadeIn" data-wow-delay="0.3s">
          <div class="position-relative">
            <img class="img-fluid w-100" src="https://technext.github.io/apex/img/fact-2.jpg" alt="" />
            <div class="facts-overlay">
        ...
        <div class="col-xl-3 col-sm-6 wow fadeIn" data-wow-delay="0.5s">
          <div class="position-relative">
            <img class="img-fluid w-100" src="https://technext.github.io/apex/img/fact-3.jpg" alt="" />
            <div class="facts-overlay">
        ...
        <div class="col-xl-3 col-sm-6 wow fadeIn" data-wow-delay="0.7s">
          <div class="position-relative">
            <img class="img-fluid w-100" src="https://technext.github.io/apex/img/fact-4.jpg" alt="" />
            <div class="facts-overlay">
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
            ...
            >
              <img
                class="position-absolute w-100 h-100"
                src="https://technext.github.io/apex/img/feature.jpg"
                alt=""
                style="object-fit: cover"
              />
              <div
        ...
        <div class="row g-4 justify-content-center">
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="service-item bg-light overflow-hidden h-100">
              <img class="img-fluid" src="https://technext.github.io/apex/img/service-1.jpg" alt="" />
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="service-item bg-light overflow-hidden h-100">
              <img class="img-fluid" src="https://technext.github.io/apex/img/service-2.jpg" alt="" />
              <div class="service-text position-relative text-center h-100 p-4">
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="service-item bg-light overflow-hidden h-100">
              <img class="img-fluid" src="https://technext.github.io/apex/img/service-3.jpg" alt="" />
              <div class="service-text position-relative text-center h-100 p-4">
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="service-item bg-light overflow-hidden h-100">
              <img class="img-fluid" src="https://technext.github.io/apex/img/service-4.jpg" alt="" />
              <div class="service-text position-relative text-center h-100 p-4">
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="service-item bg-light overflow-hidden h-100">
              <img class="img-fluid" src="https://technext.github.io/apex/img/service-5.jpg" alt="" />
              <div class="service-text position-relative text-center h-100 p-4">
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="service-item bg-light overflow-hidden h-100">
              <img class="img-fluid" src="https://technext.github.io/apex/img/service-6.jpg" alt="" />
              <div class="service-text position-relative text-center h-100 p-4">
        ...
        <div class="row g-4">
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="team-item position-relative">
              <img class="img-fluid" src="https://technext.github.io/apex/img/team-1.jpg" alt="" />
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="team-item position-relative">
              <img class="img-fluid" src="https://technext.github.io/apex/img/team-2.jpg" alt="" />
              <div class="team-text bg-white p-4">
                <h5>Full Name</h5>
                <span>Engineer</span>
              </div>
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="team-item position-relative">
              <img class="img-fluid" src="https://technext.github.io/apex/img/team-3.jpg" alt="" />
              <div class="team-text bg-white p-4">
                <h5>Full Name</h5>
                <span>Engineer</span>
              </div>
            ...
            <div class="owl-carousel testimonial-carousel">
              <div class="testimonial-item">
                <img
                  ...
                  src="https://technext.github.io/apex/img/testimonial-1.jpg"
                  alt=""
                />
                <p class="fs-5">
              ...
              <div class="testimonial-item">
                <img
                  class="img-fluid mb-4"
                  src="https://technext.github.io/apex/img/testimonial-2.jpg"
                  alt=""
                />
                <p class="fs-5">
                  Dolores sed duo clita tempor justo dolor et stet lorem kasd
    ...
    <script src="https://technext.github.io/apex/lib/wow/wow.min.js"></script>
    <script src="https://technext.github.io/apex/lib/easing/easing.min.js"></script>
    <script src="https://technext.github.io/apex/lib/waypoints/waypoints.min.js"></script>
    <script src="https://technext.github.io/apex/lib/owlcarousel/owl.carousel.min.js"></script>

    <!-- Template Javascript -->
    <script src="https://technext.github.io/apex/js/main.js"></script>
  </body>
</html>
