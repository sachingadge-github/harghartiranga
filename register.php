            ...
            <div class="col-lg-5 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                ...
                <div class="row g-6">
                  ...
                  <div class="col-sm-6 d-flex wow fadeIn" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeIn;">
                    ...
                    <button class="btn btn-info btn-sm w-100 py-3" type="button" id="corporate" onClick="alert('संस्थेच्या  इमारतीवर');">संस्थेच्या  इमारतीवर </button>
                  </div>
            ...
            <form>
              ...
              <div class="col-sm-6">
                  <div class="form-floating">
                    ...
                    <label for="gname" id="nameLabel">नाव *</label>
                  </div>
                </div>
                

                <div class="col-sm-6 corporateSection">
                  <div class="form-floating">
                  <select name="taluka"  class="form-control bg-light border-0"  id="taluka">
                        <option value="">निवडा</option>
                        <option value="">प्रकार 1</option>
                        <option value="">प्रकार 2</option>
                    </select>
                    <label for="gname">संस्थेचा प्रकार *</label>
                  </div>
                </div>
                <!-- <div class="col-sm-6">
                </div> -->
                ...
                <!-- <div class="col-sm-6">
                  <div class="form-floating">
                    <input type="text" class="form-control bg-light border-0" id="gname" placeholder="Gurdian Name">
                    <label for="gname">संस्थेचे नाव *</label>
                  </div>
                </div>
                 -->
              ...
              <div class="col-sm-6" >
                  <div class="form-floating">
                    ...
                    <label for="district">एवेन्ट् प्रकार *</label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-floating">
                    <input type="file" class="" id="gname" placeholder="Gurdian Name">
                    <label for="gname" style="position: unset !important;">फोटो अपलोड करा *</label>
                  </div>
                </div>
